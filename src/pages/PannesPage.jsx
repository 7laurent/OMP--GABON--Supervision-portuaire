...
import { AlertTriangle, Plus, Search, AlertCircle, CheckCircle2, Clock } from 'lucide-react';
import WeeklyStatsDiagram from '../components/WeeklyStatsDiagram.jsx';

export default function PannesPage({ pannes = [], onOpenAddModal, onResolvePanne }) {
  ...
  return (
    <div className="content" id="pannes-page-content">
      ...
      <WeeklyStatsDiagram 
        ...
        subtitle="Distribution des pannes par semaine, MTTR de dépannage et fréquence par équipement portuaire"
        context="pannes"
      />
          ...
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '14px', fontSize: '13px' }}>
                ...
                <div><strong>Date & Heure :</strong> {selectedPanne.date} {selectedPanne.time}</div>
                ...
                <div><strong>Durée d'arrêt estimée :</strong> {selectedPanne.durationHours || 3.5} h</div>
              </div>
