...
import { ClipboardList, Plus, Search, CheckCircle2, Clock, AlertTriangle, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="content" id="workorder-page-content">
      ...
      <WeeklyStatsDiagram 
        ...
        subtitle="Suivi hebdomadaire des ordres de travail, taux de clôture et temps d'intervention"
        context="workorders"
      />
