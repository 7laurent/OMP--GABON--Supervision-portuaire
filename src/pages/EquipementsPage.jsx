...
export default function EquipementsPage({ 
  ...
  return (
    <div className="content" id="equipements-page-content">
      ...
      <WeeklyStatsDiagram 
        pageTitle="Statistiques Multi-Périodes des Équipements Portuaires"
        subtitle="Évolution hebdomadaire, journalière et par poste des 7 types d'engins (dates détaillées)"
        context="equipements"
