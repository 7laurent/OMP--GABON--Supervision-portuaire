...
export default function GlobalKpiDashboardPage({ 
  ...
  return (
    <div className="content" id="global-kpi-dashboard-content">
      ...
      <CoreKpiTrio 
        mtbf={bilan.equipments.avgMtbf || 152.4}
        mttr={bilan.equipments.avgMttr || 2.45}
        availability={bilan.equipments.avgDo || 96.8}
        di={bilan.equipments.avgDi || 98.4}
        doVal={bilan.equipments.avgDo || 94.2}
      ...
      <WeeklyStatsDiagram 
        pageTitle="Statistiques Multi-Périodes & Comparatif Global des 7 Engins"
        subtitle="Analyses AFNOR consolidées par semaine, mois, jour et heure avec calendrier précis"
        context="dashboard"
      />
          ...
          <div className="industrial-card" style={{ borderTop: '3px solid var(--red)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '16px' }}>
              ...
              <div style={{ background: 'var(--hover-bg)', padding: '12px', borderRadius: '8px' }}>
                ...
                <div style={{ fontSize: '22px', fontWeight: 700, color: 'var(--text)', marginTop: '2px' }}>{bilan.pannes.avgReactionTimeMinutes} min</div>
          ...
          <div className="industrial-card" style={{ borderTop: '3px solid var(--green)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '16px' }}>
              ...
              <div style={{ background: 'var(--hover-bg)', padding: '12px', borderRadius: '8px' }}>
                ...
                <div style={{ fontSize: '22px', fontWeight: 700, color: 'var(--green)', marginTop: '2px' }}>{bilan.technicians.firstTimeFixRate}%</div>
