...
import { validateWorkOrderForm } from '../../utils/dataValidation.js';
...
export default function AddWorkOrderModal({ equipments = [], technicians = [], onClose, onSave }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const foundIssues = validateWorkOrderForm(formData);
          ...
          <div className="modal-body">
            ...
            {equipments.length === 0 && (
              <div style={{ padding: '10px 14px', marginBottom: '16px', background: 'rgba(239,71,111,0.12)', border: '1px solid var(--red)', borderRadius: '8px', color: 'var(--red)', fontSize: '12px' }}>
                Aucun équipement enregistré. Ajoutez d'abord un équipement avant de créer un Work Order.
              </div>
            )}
